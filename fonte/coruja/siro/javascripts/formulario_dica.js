...
function DHTMLgoodies_formTooltip()
{
	...
	this.imagePath = 'imagens/';
	this.arrowImageFile = 'seta_verde.gif';
	this.arrowImageFileRight = 'seta_verde_dir.gif';
	this.tooltipWidth = 200;
	this.tooltipBgColor = '#317082';
	this.closeMessage = 'Fechar';
	this.disableTooltipMessage = 'N&atilde;o mostrar novamente';
